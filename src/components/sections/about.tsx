...
export function About() {
  ...
  return (
    <section id="about" className="relative bg-[#0c0a09] py-10 border-t border-stone-900">
      <div className="mx-auto max-w-5xl px-6 sm:px-8">
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-12">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <p className="mt-6 text-xs text-stone-300 leading-relaxed max-w-md">
              I am a systems-focused backend developer who builds highly reliable products. Instead of coding boilerplate tutorials, I design and run systems capable of managing concurrent tasks, rate limiting, and database indexing.
            </p>
            <p className="mt-4 text-xs text-stone-300 leading-relaxed max-w-md">
          ...
          {/* technical list */}
          <div className="lg:col-span-6 flex flex-col justify-center">
            <div className="border border-stone-850 rounded-lg p-6 bg-[#0c0a09]">
              <span className="text-[9px] font-mono uppercase tracking-widest text-stone-400 block mb-6 font-bold">
